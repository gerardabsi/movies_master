...
export const Navigation: React.FC = () => (
  <Navbar expand="lg" className="main-navigation sidebar-nav">
    ...
    <Navbar id="basic-navbar-nav" className="flex-row justify-content-md-center justify-content-start flex-nowrap">
      <Nav className="mr-auto">
        <Nav.Link href="#home">
